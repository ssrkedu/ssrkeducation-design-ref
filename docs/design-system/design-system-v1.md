...
grid-template-columns: 1fr 400px; /_ desktop _/
gap: 64px;
...
gap: 20px; /_ desktop _/

4-Column (Stats desktop, Footer)

grid-template-columns: repeat(4, 1fr);
gap: 0; /_ stats bar: divided evenly _/
...
SSRK Educational Trust - Home.html
├── <style> (all CSS in one <style> block)
│ ├── CSS Variables (--blue-_, --saffron-_, etc.)
